...
namespace EGE {
     ...
     *
     * This class provides a singleton implementation for a callback function that is invoked when a GLFW window gains focus.
     ...
     *
     * The GlfwWindowScrollCallbackFunction class provides a singleton instance of a callback function
     * that can be used to handle scroll events in a GLFW window. It ensures that only one instance of
     * the callback function exists at a time.
     */
    class GlfwWindowScrollCallbackFunction {
        public:
     ...
     * @brief Represents a singleton callback function for handling key events in a GLFW window.
     *
     * The GlfwWindowContentScaleChangedCallbackFunction class provides a singleton instance of a callback function
     * that can be used to handle content scale changed events in a GLFW window. It ensures that only one instance of
     * the callback function exists at a time.
     */
    class GlfwWindowContentScaleChangedCallbackFunction {
        public:
     ...
     * @brief Represents a singleton callback function for handling key events in a GLFW window.
     *
     * The GlfwWindowFramebufferResizedCallbackFunction class provides a singleton instance of a callback function
     * that can be used to handle framebuffer resized events in a GLFW window. It ensures that only one instance of
     * the callback function exists at a time.
     */
    class GlfwWindowFramebufferResizedCallbackFunction {
        public:
     ...
     * @brief Represents a singleton callback function for handling key events in a GLFW window.
     *
     * The GlfwWindowIconifiedCallbackFunction class provides a singleton instance of a callback function
     * that can be used to handle iconified events in a GLFW window. It ensures that only one instance of
     * the callback function exists at a time.
     */
    class GlfwWindowIconifiedCallbackFunction {
        public:
     ...
     * @brief Represents a singleton callback function for handling key events in a GLFW window.
     *
     * The GlfwWindowMaximizedCallbackFunction class provides a singleton instance of a callback function
     * that can be used to handle maximized events in a GLFW window. It ensures that only one instance of
     * the callback function exists at a time.
     */
    class GlfwWindowMaximizedCallbackFunction {
        public:
     ...
     * @brief Represents a singleton callback function for handling key events in a GLFW window.
     *
     * The GlfwWindowMovedCallbackFunction class provides a singleton instance of a callback function
     * that can be used to handle moved events of a GLFW window. It ensures that only one instance of
     * the callback function exists at a time.
     */
    class GlfwWindowMovedCallbackFunction {
        public:
     ...
     * @brief Represents a singleton callback function for handling key events in a GLFW window.
     *
     * The GlfwWindowResizedCallbackFunction class provides a singleton instance of a callback function
     * that can be used to handle resized events of a GLFW window. It ensures that only one instance of
     * the callback function exists at a time.
     */
    class GlfwWindowResizedCallbackFunction {
        public:
     ...
     * @brief Represents a singleton callback function for handling key events in a GLFW window.
     *
     * The GlfwWindowRefreshedCallbackFunction class provides a singleton instance of a callback function
     * that can be used to handle refreshed events of a GLFW window. It ensures that only one instance of
     * the callback function exists at a time.
     */
    class GlfwWindowRefreshedCallbackFunction {
        public:
