...
int main()
{
    try {
        ...
        // AUDIO TEST
        EGE::Sound::Device *device = new EGE::Sound::Device();
        EGE::Sound::Sound *sound = new EGE::Sound::Sound("/home/neisan/ETIB/etib-game-engine/tests/assets/boo.wav", EGE::Sound::Sound::FileType::WAV);
